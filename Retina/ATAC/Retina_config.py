...
class Config(object):
    def __init__(self):
        ...
        if DB == '10x':
            ...
            self.rna_paths = ['data/Retina_rna.npz']
            self.rna_labels = ['data/Retina_cellType_rna.txt']		
            self.atac_paths = ['data/Retina_atac.npz']
            self.atac_labels = ['data/Retina_cellType_atac.txt'] #Optional. If atac_labels are provided, accuracy after knn would be provided.
            ...
            self.p = 0.8
            self.embedding_size = 64 ##couldn't change to 100, sticking with 64
            self.momentum = 0.9
