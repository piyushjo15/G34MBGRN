...
region_bin_topics_otsu = pickle.load(open(os.path.join(projDir,Sample, 'candidate_enhancers/region_bin_topics_otsu.pkl'), 'rb'))
region_bin_topics_top3k = pickle.load(open(os.path.join(projDir, Sample,'candidate_enhancers/region_bin_topics_top3k.pkl'), 'rb'))
markers_dict = pickle.load(open(os.path.join(projDir,Sample,'candidate_enhancers/markers_dict.pkl'), 'rb'))
...
db_fpath ='ATACana/SCENIC/pycistarget/database/'
motif_annot_fpath ='ATACana/SCENIC/pycistarget/motif_annotation/'
...
#run pycisTarget
if not os.path.exists(os.path.join(projDir,Sample, 'pycistarget')):
  os.makedirs(os.path.join(projDir, Sample, 'pycistarget'))

projDir = os.path.join("Retina/SCENIC/",Sample,"pycistarget")
