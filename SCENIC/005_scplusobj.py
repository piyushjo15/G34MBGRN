...
adata = sc.read_h5ad(os.path.join(projDir, 'RNA',Sample,'adata.h5ad'))
cistopic_obj = dill.load(open(os.path.join(projDir, 'scATAC',Sample,'cistopic_obj.pkl'), 'rb'))
menr = dill.load(open(os.path.join(projDir, 'pycistarget',Sample,'motifs/menr.pkl'),'rb'))
